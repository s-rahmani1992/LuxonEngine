...
LuxonEngine::Rendering::DX12::DX12CommandExecuter::DX12CommandExecuter(ComPtr<ID3D12CommandQueue> commandQueue, ComPtr<ID3D12Fence1> fence)
	: m_commandQueue(commandQueue), m_fence(fence), 
	m_fence_value(0), m_sync_event(CreateEventW(nullptr, FALSE, FALSE, nullptr))
{
}

LuxonEngine::Rendering::DX12::DX12CommandExecuter::~DX12CommandExecuter()
{
