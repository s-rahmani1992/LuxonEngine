...
#define _tileFactor CurveProps.tileFactor
...
void cs_main( uint3 DTid : SV_DispatchThreadID )
{
    ...
    _vertexBuffer[DTid.x].texCoord = float2(0.0f, _tileFactor * _length * Length(_startPoint, _midPoint, _endPoint, t) / _length);
}